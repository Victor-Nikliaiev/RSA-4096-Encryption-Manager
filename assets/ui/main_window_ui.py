...
class Ui_main_window(object):
    ...
    def retranslateUi(self, main_window):
        ...
        self.actionEnglish.setText(
            QCoreApplication.translate("main_window", "English", None)
        )
        self.action.setText(
            QCoreApplication.translate(
                "main_window", "\u0420\u0443\u0441\u0441\u043a\u0438\u0439", None
            )
        )
        self.actionEspa_ol.setText(
            QCoreApplication.translate("main_window", "Espa\u00f1ol", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "main_window",
        ...
        self.menuLanguage.setTitle(
            QCoreApplication.translate("main_window", "Language", None)
        )
