...
class Ui_choose_file_window_ui(object):
    def setupUi(self, choose_file_window_ui):
        if not choose_file_window_ui.objectName():
            choose_file_window_ui.setObjectName("choose_file_window_ui")
        ...
        self.drop_and_drag_widget.setObjectName("drop_and_drag_widget")
    ...
    def retranslateUi(self, choose_file_window_ui):
        ...
        self.label.setText(
            QCoreApplication.translate(
                "choose_file_window_ui",
                'Please choose a file and click "Next" button',
                None,
            )
        )
        self.next_button.setText(
            QCoreApplication.translate("choose_file_window_ui", "Next", None)
        )
