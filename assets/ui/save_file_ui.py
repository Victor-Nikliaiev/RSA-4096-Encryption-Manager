...
class Ui_SaveFileForm(object):
    def setupUi(self, SaveFileForm):
        if not SaveFileForm.objectName():
            SaveFileForm.setObjectName(u"SaveFileForm")
        ...
        SaveFileForm.setStyleSheet(u"QWidget {\n"
...
"}")
        ...
        self.input_file_info_btn.setObjectName(u"input_file_info_btn")
        ...
        sizePolicy.setHeightForWidth(self.input_file_info_btn.sizePolicy().hasHeightForWidth())
        self.input_file_info_btn.setSizePolicy(sizePolicy)
        self.input_file_info_btn.setMinimumSize(QSize(0, 60))
        self.input_file_info_btn.setStyleSheet(u"background-color: rgb(38, 50, 56);\n"
"color: rgb(83, 106, 117);\n"
"font-size: 25px;")
        icon1 = QIcon()
        icon1.addFile(u":/windows_icons/icons/encrypt_file.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.file_chooser_input.setObjectName(u"file_chooser_input")
        self.file_chooser_input.setEnabled(False)
        self.file_chooser_input.setMinimumSize(QSize(0, 50))
        self.file_chooser_input.setStyleSheet(u"border-radius: 3px;")
        ...
        self.output_file_info_btn.setObjectName(u"output_file_info_btn")
        self.output_file_info_btn.setEnabled(False)
        sizePolicy.setHeightForWidth(self.output_file_info_btn.sizePolicy().hasHeightForWidth())
        self.output_file_info_btn.setSizePolicy(sizePolicy)
        self.output_file_info_btn.setMinimumSize(QSize(0, 60))
        self.output_file_info_btn.setStyleSheet(u"background-color: rgb(38, 50, 56);\n"
"color: rgb(83, 106, 117);\n"
"font-size: 25px;")
        icon2 = QIcon()
        icon2.addFile(u":/windows_icons/icons/file.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.saved_name_input.setObjectName(u"saved_name_input")
        self.saved_name_input.setEnabled(False)
        self.saved_name_input.setMinimumSize(QSize(0, 50))
        self.saved_name_input.setStyleSheet(u"border-radius: 3px;")
        ...
        self.save_file_button.setStyleSheet(u"#save_file_button {\n"
...
"}")
        ...
        self.start_button.setStyleSheet(u"#start_button {\n"
"	background-color: #007d9c;\n"
"	color: #005568;\n"
"	font-size: 32px;\n"
"}\n"
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/windows_icons/icons/next.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, SaveFileForm):
        SaveFileForm.setWindowTitle(QCoreApplication.translate("SaveFileForm", u"[PLACEHOLDER] |  Choose file name", None))
        self.groupBox.setTitle("")
        self.input_file_info_btn.setText(QCoreApplication.translate("SaveFileForm", u"File to be encrypted:", None))
        self.file_chooser_input.setPlaceholderText(QCoreApplication.translate("SaveFileForm", u"Path to selected file...[PLACEHOLDER]", None))
        self.output_file_info_btn.setText(QCoreApplication.translate("SaveFileForm", u"Choose file name for encrypted file:", None))
        self.saved_name_input.setPlaceholderText(QCoreApplication.translate("SaveFileForm", u"Click \"Save\" button to choose file name...", None))
        self.save_file_button.setText(QCoreApplication.translate("SaveFileForm", u"Save", None))
        self.start_button.setText(QCoreApplication.translate("SaveFileForm", u"Start Encryption", None))
    # retranslateUi
