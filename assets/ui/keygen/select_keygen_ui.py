...
class Ui_SelectKeygen(object):
    def setupUi(self, SelectKeygen):
        if not SelectKeygen.objectName():
            SelectKeygen.setObjectName("SelectKeygen")
        ...
        self.groupBox.setStyleSheet("background-color: #415661;")
        ...
        self.gen_priv_key_rb.setObjectName("gen_priv_key_rb")
        ...
        sizePolicy2.setHeightForWidth(
            self.gen_priv_key_rb.sizePolicy().hasHeightForWidth()
        )
        ...
        self.gen_pub_key_rb.setObjectName("gen_pub_key_rb")
        sizePolicy2.setHeightForWidth(
            self.gen_pub_key_rb.sizePolicy().hasHeightForWidth()
        )
        ...
        self.gen_key_pair_rb.setObjectName("gen_key_pair_rb")
        sizePolicy2.setHeightForWidth(
            self.gen_key_pair_rb.sizePolicy().hasHeightForWidth()
        )
        ...
        self.label_2.setPixmap(QPixmap(":/misc/icons/cyber_key.png"))
    ...
    def retranslateUi(self, SelectKeygen):
        SelectKeygen.setWindowTitle(
            QCoreApplication.translate("SelectKeygen", "Select Keygen Option", None)
        )
        self.label.setText(
            QCoreApplication.translate("SelectKeygen", "Select an option:", None)
        )
        self.groupBox.setTitle("")
        self.gen_priv_key_rb.setText(
            QCoreApplication.translate("SelectKeygen", "Generate private key", None)
        )
        self.gen_pub_key_rb.setText(
            QCoreApplication.translate("SelectKeygen", "Generate public key", None)
        )
        self.gen_key_pair_rb.setText(
            QCoreApplication.translate(
                "SelectKeygen", "Generate public and private key", None
            )
        )
        self.next_button.setText(
            QCoreApplication.translate("SelectKeygen", "Next", None)
        )
