...
class Ui_PublicKeygen(object):
    def setupUi(self, PublicKeygen):
        if not PublicKeygen.objectName():
            PublicKeygen.setObjectName("PublicKeygen")
        ...
        self.private_key_sel_btn.setStyleSheet(
            "QPushButton {background-color: #007d9c;\n"
            "color: #005568;\n"
            " }\n"
            "\n"
            "QPushButton:hover {\n"
        ...
        self.pub_key_select_btn.setStyleSheet(
            "QPushButton {\n"
    ...
    def retranslateUi(self, PublicKeygen):
        PublicKeygen.setWindowTitle(
            QCoreApplication.translate(
                "PublicKeygen",
                "Key Manager | Select location to generate your public key",
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "PublicKeygen",
                "Select your private key to generate the public key:",
                None,
            )
        )
        self.groupBox.setTitle("")
        self.private_key_path_le.setPlaceholderText(
            QCoreApplication.translate(
                "PublicKeygen", 'Click "Select Private Key"', None
            )
        )
        self.private_key_sel_btn.setText(
            QCoreApplication.translate("PublicKeygen", "  Select Private Key", None)
        )
        self.password_cb.setText(
            QCoreApplication.translate("PublicKeygen", "Password-encrypted?", None)
        )
        ...
        self.pushButton_2.setText(
            QCoreApplication.translate(
                "PublicKeygen", "  Select location to save your public key:", None
            )
        )
        self.pub_key_path_le.setPlaceholderText(
            QCoreApplication.translate(
                "PublicKeygen",
                'Click "Select" to choose location to save your public key',
                None,
            )
        )
        self.pub_key_select_btn.setText(
            QCoreApplication.translate("PublicKeygen", " Select", None)
        )
        self.generate_btn.setText(
            QCoreApplication.translate("PublicKeygen", "Generate", None)
        )
