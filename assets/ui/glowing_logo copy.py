...
class GlowingLogo(QMainWindow):
    def __init__(self):
        ...
        @-webkit-keyframes glow {
            from {
                text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #06dbe6, 0 0 40px #06dbe6, 0 0 50px #06dbe6, 0 0 60px #06dbe6, 0 0 70px #06dbe6;
            }
            
            to {
                text-shadow: 0 0 20px #fff, 0 0 30px #49ffff, 0 0 40px #49ffff, 0 0 50px #49ffff, 0 0 60px #49ffff, 0 0 70px #49ffff, 0 0 80px #49ffff;
            }
        }
        </style>
        </head>
