...
class ChunkEncrypter:
    ...
    def public_key(self) -> RSAPublicKey:
        ...
        if not self._public_key:
            self._public_key = self.key_manager.load_public_key_from_file(
    ...
    def private_key(self) -> RSAPrivateKey:
        ...
        if not self._private_key:
            self._private_key = self.key_manager.load_private_key_from_file(
    ...
    def encrypt_chunk(self, chunk: bytes) -> bytes:
        ...
        return self.public_key.encrypt(chunk, self.get_padding())
    ...
    def decrypt_chunk(self, chunk: bytes) -> bytes:
        ...
        return self.private_key.decrypt(chunk, self.get_padding())
