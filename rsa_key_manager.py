...
class RsaKeyManager:
    ...
    def save_private_key_to_file(self, private_key, pem_file_path, password: str = None):
        """
    ...
    def load_private_key_from_file(self, pem_file_path, password: str = None):
        ...
        try:
            with open(pem_file_path, 'rb') as private_file:
                private_key = serialization.load_pem_private_key(private_file.read(), password=password, backend=default_backend())
    ...
    def load_public_key_from_file(self, pem_file_path):
        ...
        try:
            ...
            logging.error(f"Public key file not found: {pem_file_path}")
        except Exception as e:
